...
![server.c](image/3.png){ width=100% }

![server.c](image/4.png){ width=100% }

![server.c](image/5.png){ width=100% }
...
![client.c](image/7.png){ width=100% }
...
![Проверка](image/10.png){ width=100% }
